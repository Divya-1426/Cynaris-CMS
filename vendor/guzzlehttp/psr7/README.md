...
```php
$base = new Uri('/a/b/');
echo UriResolver::relativize($base, new Uri('/a/b/c'));  // prints 'c'.
echo UriResolver::relativize($base, new Uri('/a/x/y'));  // prints '../x/y'.
echo UriResolver::relativize($base, new Uri('/a/b/?q')); // prints '?q'.
echo UriResolver::relativize($base, new Uri(''));   // prints '//example.org/a/b/'.
```
