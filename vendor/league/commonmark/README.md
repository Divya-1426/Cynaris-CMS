...
Custom parsers/renderers can be bundled into extensions which extend CommonMark.  Here are some that you may find interesting:
 ...
 - [Sup Sub extensions]() - Adds support of superscript and subscript (`<sup>` and `<sub>` HTML tags)
 ...
 - [Marker Extension]() - Adds support of highlighted text (`<mark>` HTML tag)
...
<div align="center">
	<b>
		<a href="">Get professional support for league/commonmark with a Tidelift subscription</a>
	</b>
	<br>
	<sub>
...
[docs-examples]: 
[docs-example-twitter]: 
[docs-example-smilies]: 
[All Contributors]: 
