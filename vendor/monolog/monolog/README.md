...
Get supported Monolog and help fund the project with the [Tidelift Subscription](https://tidelift.com/subscription/pkg/packagist-monolog-monolog?utm_source=packagist-monolog-monolog&utm_medium=referral&utm_campaign=enterprise) or via [GitHub sponsorship](). 
...
- [CakePHP](http://cakephp.org/) is usable with Monolog via the [cakephp-monolog]() plugin.
- [Slim](http://www.slimframework.com/) is usable with Monolog via the [Slim-Monolog]() log writer.
- [XOOPS 2.6](http://xoops.org/) comes out of the box with Monolog.
- [Aura.Web_Project]() comes out of the box with Monolog.
- [Nette Framework](http://nette.org/en/) is usable with Monolog via the [contributte/monolog]() or [orisai/nette-monolog]() extensions.
...
- [Yii 2](http://www.yiiframework.com/) is usable with Monolog via the [yii2-monolog]() or [yii2-psr-log-target]() plugins.
...
- [Aimeos ecommerce framework](https://aimeos.org/) is usable with Monolog via the [ai-monolog]() extension.
