...
[![License]()](https://packagist.org/packages/voku/portable-ascii)
...
For support and donations please visit [Github]() | [Issues](issues) | [PayPal](https://paypal.me/moelleken) | [Patreon](https://www.patreon.com/voku).

For status updates and release announcements please visit [Releases](releases) | [Twitter](https://twitter.com/suckup_de) | [Patreon](https://www.patreon.com/voku/posts).
...
- Thanks to [PHPStan](/phpstan/phpstan) && [Psalm](/vimeo/psalm) for really great Static analysis tools and for discover bugs in the code!
