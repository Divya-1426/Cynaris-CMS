        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <span><?php echo e(__('dashboard.prefer_cells', ['cells' => '3-4'])); ?></span>
                </div>
                <div class="card-body">
                          ...
                          <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <img src="<?php echo e(asset('uploads/'.$path.'/'.$row->image_path)); ?>" class="img-fluid" alt="Slider">
                                    <?php endif; ?>
                                </td>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cynaris\resources\views/admin/slider/index.blade.php ENDPATH**/ ?>