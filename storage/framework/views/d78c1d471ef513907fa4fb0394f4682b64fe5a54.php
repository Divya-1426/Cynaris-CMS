                    ...
                    <table id="basic-datatable" class="table table-striped table-hover table-dark nowrap full-width">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo e(__('dashboard.quote_no')); ?></th>
                                <th><?php echo e(__('dashboard.name')); ?></th>
                                <th><?php echo e(__('dashboard.email')); ?></th>
                                <th><?php echo e(__('dashboard.quote_placed')); ?></th>
                          ...
                          <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="badge badge-info badge-pill"><?php echo e(__('dashboard.estimated')); ?></span>
                                    <?php elseif( $row->status == 3 ): ?>
                                    <span class="badge badge-success badge-pill"><?php echo e(__('dashboard.approved')); ?></span>
                                    <?php elseif( $row->status == 0 ): ?>
                                    <span class="badge badge-danger badge-pill"><?php echo e(__('dashboard.rejected')); ?></span>
                                    <?php endif; ?>
                                </td>
                                <td>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cynaris\resources\views/admin/get-quote/index.blade.php ENDPATH**/ ?>