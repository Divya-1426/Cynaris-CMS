            ...
            <div class="modal-content">
              <form class="needs-validation" novalidate action="<?php echo e(route($route.'.update', $row->id)); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="image"><?php echo e(__('dashboard.thumbnail')); ?> <span><?php echo e(__('dashboard.image_size', ['height' => 800, 'width' => 1920])); ?></span></label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="url" class="form-control" name="link" id="link" value="<?php echo e($row->link); ?>">
    ...
    </div><!-- /.modal --><?php /**PATH C:\xampp\htdocs\cynaris\resources\views/admin/slider/edit.blade.php ENDPATH**/ ?>