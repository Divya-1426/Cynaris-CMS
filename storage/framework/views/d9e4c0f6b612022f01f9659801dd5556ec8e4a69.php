        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <span><?php echo e(__('dashboard.prefer_cells', ['cells' => 4])); ?></span>
                </div>
                <div class="card-body">
                    ...
                    <table id="basic-datatable" class="table table-striped table-hover table-dark nowrap full-width">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo e(__('dashboard.value')); ?></th>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cynaris\resources\views/admin/counter/index.blade.php ENDPATH**/ ?>