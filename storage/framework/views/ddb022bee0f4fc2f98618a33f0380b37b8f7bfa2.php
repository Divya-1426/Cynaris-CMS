        ...
        <div class="col-12 col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="image"><?php echo e(__('dashboard.thumbnail')); ?> <span>*</span> <span><?php echo e(__('dashboard.image_size', ['height' => 280, 'width' => 500])); ?></span></label>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cynaris\resources\views/admin/article/create.blade.php ENDPATH**/ ?>