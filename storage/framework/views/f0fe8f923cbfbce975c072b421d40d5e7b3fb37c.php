            ...
            <div class="modal-content">
              <form class="needs-validation" novalidate action="<?php echo e(route($route.'.store')); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="value"><?php echo e(__('dashboard.value')); ?> <span>*</span></label>
                        <input type="number" class="form-control" name="value" id="value" value="<?php echo e(old('value')); ?>" required>

                        <div class="invalid-feedback">
                          <?php echo e(__('dashboard.please_provide')); ?> <?php echo e(__('dashboard.value')); ?>
    ...
    </div><!-- /.modal --><?php /**PATH C:\xampp\htdocs\cynaris\resources\views/admin/counter/create.blade.php ENDPATH**/ ?>