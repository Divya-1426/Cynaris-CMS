            ...
            <div class="modal-content">
              <form class="needs-validation" novalidate action="<?php echo e(route($route.'.store')); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="image"><?php echo e(__('dashboard.thumbnail')); ?> <span>*</span>
                         <span><?php echo e(__('dashboard.image_size', ['height' => 800, 'width' => 1920])); ?></span></label>
                    ...
                    <div class="form-group">
                        <label for="link"><?php echo e(__('dashboard.web_link')); ?></label>
                        <input type="url" class="form-control" name="link" id="link" value="<?php echo e(old('link')); ?>">

                        <div class="invalid-feedback">
                          <?php echo e(__('dashboard.please_provide')); ?> <?php echo e(__('dashboard.web_link')); ?>
    ...
    </div><!-- /.modal --><?php /**PATH C:\xampp\htdocs\cynaris\resources\views/admin/slider/create.blade.php ENDPATH**/ ?>