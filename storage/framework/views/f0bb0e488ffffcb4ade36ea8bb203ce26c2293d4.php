        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- Details View Start -->
                    <h4><span class="text-highlight"><?php echo e(__('dashboard.designation')); ?>:</span> <?php echo e($row->title); ?></h4>
                    <p><span class="text-highlight"><?php echo e(__('dashboard.department')); ?>:</span> <?php echo e($row->department); ?></p>
                    <hr/>
    ...
    </div><!-- /.modal --><?php /**PATH C:\xampp\htdocs\cynaris\resources\views/admin/designation/show.blade.php ENDPATH**/ ?>