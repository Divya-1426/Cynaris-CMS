        ...
        <div class="col-12 col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="short_desc"><?php echo e(__('dashboard.short_desc')); ?> <span>*</span></label>
                        <textarea class="form-control summernote" name="short_desc" id="short_desc" rows="4" required><?php echo e($row->short_desc); ?></textarea>

                        <div class="invalid-feedback">
                          <?php echo e(__('dashboard.please_provide')); ?> <?php echo e(__('dashboard.short_desc')); ?>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cynaris\resources\views/admin/service/edit.blade.php ENDPATH**/ ?>