                    ...
                    <table id="basic-datatable" class="table table-striped table-hover table-dark nowrap full-width">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo e(__('dashboard.thumbnail')); ?></th>
                          ...
                          <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <img src="<?php echo e(asset('uploads/'.$path.'/'.$row->image_path)); ?>" class="img-fluid" alt="Service">
                                    <?php endif; ?>
                                </td>
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo e(route($route.'.edit', [$row->id])); ?>" class="btn btn-primary btn-sm">
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cynaris\resources\views/admin/service/index.blade.php ENDPATH**/ ?>